-- Urbanexus one-shot setup — paste into Supabase SQL Editor and Run
-- Project: https://supabase.com/dashboard/project/kgsmdprurziemjmkouha/sql/new
...
-- Demo sync: allow publishable API key to read/write (no secret key required)
...
alter table public.moderation_events disable row level security;
